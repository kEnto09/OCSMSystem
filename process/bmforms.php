...
<head>
    ...
    <link href="../fonts/Family.css" rel="stylesheet" type="text/css">
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Karl Joseph Saycon</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills">Web Developer - One Media Creator - Programmer - All Weekend Trolly Man</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                          ...
                          <form id="form1" name="form1" method="post" action="../admin/process/bmlogin.php">
                            User Name:<br />
                           ...
                           <br />
                           <br />
                           <strong><button type="submit" name="button" class="btn btn-default btn-xs" id="button">Login
                         </button></strong>
                        </form>
                                <li>Client:
    ...
    <!-- Plugin JavaScript -->
    <script src="../js/js.easing.min.js"></script>
