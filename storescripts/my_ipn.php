...
if (strpos($curl_result, "VERIFIED") !== false) {
	...
	mail("skgladyken@gmail.com", "IPN interaction not verified", "$req", "From: skgladyken@gmail.com" );
	exit();
}
...
if ($receiver_email != "skgladyken@gmail.com") {
	$message = "Investigate why and how receiver email is wrong. Email = " . $_POST['receiver_email'] . "\n\n\n$req";
    mail("skgladyken@gmail.com", "Receiver Email is incorrect", $message, "From: skgladyken@gmail.com" );
    exit(); // exit script
}
// Check number 2 ------------------------------------------------------------------------------------------------------------
...
if ($numRows > 0) {
    ...
    mail("skgladyken@gmail.com", "Duplicate txn_id in the IPN system", $message, "From: skgladyken@gmail.com" );
    exit(); // exit script
} 
// Check number 4 ------------------------------------------------------------------------------------------------------------
...
if ($fullAmount != $grossAmount) {
        ...
        mail("skgladyken@gmail.com", "Price Jack or Bad Programming", $message, "From: skgladyken@gmail.com" );
        exit(); // exit script
} 
...
mail("skgladyken@gmail.com", "NORMAL IPN RESULT YAY MONEY!", $req, "From: skgladyken@gmail.com");
?>